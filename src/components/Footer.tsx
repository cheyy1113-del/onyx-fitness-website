        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 mb-16">
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-2.5 text-xs font-semibold">
              ...
              <li><a href="#training" className="hover:text-[#E50914] transition-colors">Training Services</a></li>
              <li><a href="#team" className="hover:text-[#E50914] transition-colors">Coaching Team</a></li>
              <li><a href="#pricing" className="hover:text-[#E50914] transition-colors">Pricing Schedules</a></li>
              <li><a href="#transform" className="hover:text-[#E50914] transition-colors">Transformation Program</a></li>
